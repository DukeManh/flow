...
const CACHE_NAME = 'flow-cache-v1.2.1'; // Updated for todo upload improvements
const SW_VERSION = '2025-08-26'; // Version identifier updated for todo upload features
